...
parser.add_argument('--api_url', type=str, default="https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions", help="qwen api url.")
parser.add_argument('--api_token', type=str, help="Your qwen api token.")
...
# Your qwen-turbo API URL
API_url = args.api_url

# Your qwen-turbo API Token
...
while True:
    ...
    if reflection_switch:
        ...
        if 'A' in reflect:
            ...
            output_planning = inference_chat(chat_planning, 'qwen-turbo', API_url, token)
